 ...
 */
//#define USE_CONTROLLER_FAN //Jeff: bruger 12/24v konstant power out istedet
...
#define ENDSTOPS_ALWAYS_ON_DEFAULT  //Jeff Org: Disabled
...
//#define X_DUAL_STEPPER_DRIVERS //Jeff Org: Disabled
 ...
 */
#define Z_STEPPER_AUTO_ALIGN //Jeff Org: Disabled by default
...
//#define LCD_SHOW_E_TOTAL
   ...
   */
  #define SDCARD_CONNECTION LCD //Jeff: Org Undefined //#define SDCARD_CONNECTION LCD
 ...
 */
#define ADVANCED_PAUSE_FEATURE //Jeff org: disabled 
 ...
 */
  ...
  #if AXIS_IS_TMC(X)
    #define X_CURRENT        760  //Jeff Org: 800 // (mA) RMS current. Multiply by 1.414 for peak current.
  ...
  #if AXIS_IS_TMC(Z2)
    #define Z2_CURRENT      760 //Jeff Org: 800
  ...
  #if AXIS_IS_TMC(E1)
    #define E1_CURRENT      760 //Jeff Org: 800
   ...
   */
  #define MONITOR_DRIVER_STATUS //Jeff Org: Disabled
  ...
  #define SENSORLESS_HOMING // StallGuard capable drivers only
    ...
    #define X_STALL_SENSITIVITY  155 //jeff org: 130
    #define X2_STALL_SENSITIVITY X_STALL_SENSITIVITY
    #define Y_STALL_SENSITIVITY  155 //jeff org: 130 //135 gav en falsk positiv
   ...
   */
  #define TMC_DEBUG //Jeff Org: Disabled
...
#define M114_DETAIL         // Use 'M114` for details to check planner calculations //Jef org: Disabled . I've enabled because of filament sensor
